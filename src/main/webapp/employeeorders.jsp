...
<section>
    ...
    <div class="row">
        <div class="col-md-4">
            <h4>Aktualnie prowadzone naprawy przez ${employee.first_name} ${employee.last_name}</h4>
        </div>
        <div class="col-md-8">
            <div class="row">
                <div class="col-md-4">
                    <button type="button" class="btn btn-info btn-md" onclick="window.location.href = '/addordertoemployee?id=${employee.id}';">
                        Dodaj
                    </button>
                </div>
